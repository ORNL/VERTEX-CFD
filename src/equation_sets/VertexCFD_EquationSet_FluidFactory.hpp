#ifndef VERTEXCFD_EQUATIONSET_FLUIDFACTORY_HPP
#define VERTEXCFD_EQUATIONSET_FLUIDFACTORY_HPP

#include "VertexCFD_EquationSet_IncompressibleLSVOF.hpp"
...
PANZER_DECLARE_EQSET_TEMPLATE_BUILDER(IncompressibleLSVOF, IncompressibleLSVOF)
PANZER_DECLARE_EQSET_TEMPLATE_BUILDER(IncompressibleNavierStokes,
                                      IncompressibleNavierStokes)

//---------------------------------------------------------------------------//
class FluidFactory : public panzer::EquationSetFactory
{
  public:
                     ...
                     const bool build_transient_support) const override
    {
        ...
        PANZER_BUILD_EQSET_OBJECTS("IncompressibleNavierStokes",
                                   IncompressibleNavierStokes);
        PANZER_BUILD_EQSET_OBJECTS("IncompressibleLSVOF", IncompressibleLSVOF);
...
#endif // end VERTEXCFD_EQUATIONSET_FLUIDFACTORY_HPP
