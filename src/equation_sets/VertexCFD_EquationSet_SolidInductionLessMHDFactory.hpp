#ifndef VERTEXCFD_EQUATIONSET_SOLIDINDUCTIONLESSMHDFACTORY_HPP
#define VERTEXCFD_EQUATIONSET_SOLIDINDUCTIONLESSMHDFACTORY_HPP

#include "VertexCFD_EquationSet_SolidInductionLessMHD.hpp"
...
PANZER_DECLARE_EQSET_TEMPLATE_BUILDER(SolidInductionLessMHD,
                                      SolidInductionLessMHD)

//---------------------------------------------------------------------------//
class SolidInductionLessMHDFactory : public panzer::EquationSetFactory
{
  public:
                     ...
                     const bool build_transient_support) const override
    {
        ...
        PANZER_BUILD_EQSET_OBJECTS("SolidInductionLessMHD",
                                   SolidInductionLessMHD);
...
#endif // end VERTEXCFD_EQUATIONSET_SOLIDINDUCTIONLESSMHDFACTORY_HPP
