#ifndef VERTEXCFD_EQUATIONSET_FULLINDUCTIONMHDFACTORY_HPP
#define VERTEXCFD_EQUATIONSET_FULLINDUCTIONMHDFACTORY_HPP

#include "VertexCFD_EquationSet_FullInductionMHD.hpp"
...
{
//---------------------------------------------------------------------------//
PANZER_DECLARE_EQSET_TEMPLATE_BUILDER(FullInductionMHD, FullInductionMHD)

//---------------------------------------------------------------------------//
class FullInductionMHDFactory : public panzer::EquationSetFactory
{
  public:
...
#endif // end VERTEXCFD_EQUATIONSET_FULLINDUCTIONMHDFACTORY_HPP
