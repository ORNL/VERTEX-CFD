#ifndef VERTEXCFD_EQUATIONSET_CONDUCTIONFACTORY_HPP
#define VERTEXCFD_EQUATIONSET_CONDUCTIONFACTORY_HPP

#include "VertexCFD_EquationSet_Conduction.hpp"
...
{
//---------------------------------------------------------------------------//
PANZER_DECLARE_EQSET_TEMPLATE_BUILDER(Conduction, Conduction)

//---------------------------------------------------------------------------//
class ConductionFactory : public panzer::EquationSetFactory
{
  public:
                     ...
                     const bool build_transient_support) const override
    {
        ...
        PANZER_BUILD_EQSET_OBJECTS("Conduction", Conduction);
...
#endif // end VERTEXCFD_EQUATIONSET_CONDUCTIONFACTORY_HPP
