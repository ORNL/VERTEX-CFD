#ifndef VERTEXCFD_BOUNDARYCONDITION_SOLIDELECTRICBOUNDARYFLUX_HPP
#define VERTEXCFD_BOUNDARYCONDITION_SOLIDELECTRICBOUNDARYFLUX_HPP
...
class SolidElectricBoundaryFlux
    : public BoundaryFluxBase<EvalType, NumSpaceDim>
{
  public:
    SolidElectricBoundaryFlux(
        const panzer::BC& bc,
...
#endif // end VERTEXCFD_BOUNDARYCONDITION_SOLIDELECTRICBOUNDARYFLUX_HPP
