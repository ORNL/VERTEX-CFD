                      ...
                      public PHX::EvaluatorDerived<EvalType, panzer::Traits>
{
        ...
        , velocity_2("velocity_2", ir.dl_scalar)
    {
        ...
        this->setName(
            "RAD Equation Exact Solution Unit Test "
            "Dependencies");
    }
    ...
    {
        Kokkos::parallel_for(
            "RAD equation test dependencies",
...
void testEval(const bool build_reaction = false,
              ...
              const bool build_diffusion = false)
{
    ...
    auto eval = Teuchos::rcp(
        new ClosureModel::RADExactSolution<EvalType, panzer::Traits, num_space_dim>(
