#ifndef VERTEXCFD_CLOSURE_RADBADExactSolution_HPP
#define VERTEXCFD_CLOSURE_RADBADExactSolution_HPP
...
{
//---------------------------------------------------------------------------//
// Bateman Advection Diffusion equation exact solution.
//---------------------------------------------------------------------------//
template<class EvalType, class Traits, int NumSpaceDim>
class RADBADExactSolution : public panzer::EvaluatorWithBaseImpl<Traits>,
...
#endif // VERTEXCFD_CLOSURE_RADBADExactSolution_HPP
