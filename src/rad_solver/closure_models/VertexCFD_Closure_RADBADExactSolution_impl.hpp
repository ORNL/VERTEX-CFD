#ifndef VERTEXCFD_CLOSURE_RADBADExactSolution_IMPL_HPP
#define VERTEXCFD_CLOSURE_RADBADExactSolution_IMPL_HPP
...
RADBADExactSolution<EvalType, Traits, NumSpaceDim>::RADBADExactSolution(
...
//---------------------------------------------------------------------------//
template<class EvalType, class Traits, int NumSpaceDim>
void RADBADExactSolution<EvalType, Traits, NumSpaceDim>::postRegistrationSetup(
...
//---------------------------------------------------------------------------//
template<class EvalType, class Traits, int NumSpaceDim>
void RADBADExactSolution<EvalType, Traits, NumSpaceDim>::evaluateFields(
...
RADBADExactSolution<EvalType, Traits, NumSpaceDim>::operator()(
...
#endif // VERTEXCFD_CLOSURE_RADBADExactSolution_IMPL_HPP