#ifndef VERTEXCFD_BOUNDARYCONDITION_INCOMPRESSIBLELSVOFBOUNDARYFLUX_HPP
#define VERTEXCFD_BOUNDARYCONDITION_INCOMPRESSIBLELSVOFBOUNDARYFLUX_HPP
...
class IncompressibleLSVOFBoundaryFlux
    : public BoundaryFluxBase<EvalType, NumSpaceDim>
{
  ...
  private:
    ...
    Teuchos::ParameterList _lsvof_params;
    bool _build_mom_eqn;
    std::vector<std::string> _dof_phase_names;
    std::vector<std::string> _all_phase_names;
};
...
#endif // end VERTEXCFD_BOUNDARYCONDITION_INCOMPRESSIBLELSVOFBOUNDARYFLUX_HPP
