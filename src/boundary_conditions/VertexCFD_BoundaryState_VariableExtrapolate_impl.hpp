#ifndef VERTEXCFD_BOUNDARYSTATE_VARIABLEEXTRAPOLATE_IMPL_HPP
#define VERTEXCFD_BOUNDARYSTATE_VARIABLEEXTRAPOLATE_IMPL_HPP
...
VariableExtrapolate<EvalType, Traits>::VariableExtrapolate(
    ...
    , _num_grad_dim(ir.spatial_dimension)
{
    ...
    this->setName(variable_name + " Boundary State Variable Extrapolate "
                  + std::to_string(_num_grad_dim) + "D");
}

//---------------------------------------------------------------------------//
template<class EvalType, class Traits>
void VariableExtrapolate<EvalType, Traits>::evaluateFields(
...
//---------------------------------------------------------------------------//
template<class EvalType, class Traits>
KOKKOS_INLINE_FUNCTION void VariableExtrapolate<EvalType, Traits>::operator()(
...
#endif // end VERTEXCFD_BOUNDARYSTATE_VARIABLEEXTRAPOLATE_IMPL_HPP
