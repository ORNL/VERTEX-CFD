...
void testEval()
{
    ...
    lsvof_params.set<int>("Number of Phases", 3);
    ...
    // Expected values
    const double exp_rho = ph0_rho * a0 + ph1_rho * a1 + ph2_rho * a2;
    const double exp_mu = ph0_mu * a0 + ph1_mu * a1 + ph2_mu * a2;
