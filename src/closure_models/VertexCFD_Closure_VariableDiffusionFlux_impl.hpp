#ifndef VERTEXCFD_CLOSURE_VARIABLEDIFFUSIONFLUX_IMPL_HPP
#define VERTEXCFD_CLOSURE_VARIABLEDIFFUSIONFLUX_IMPL_HPP
...
VariableDiffusionFlux<EvalType, Traits>::VariableDiffusionFlux(
    ...
    , _grad_var(gradient_prefix + "GRAD_" + _variable_name, ir.dl_vector)
{
    ...
    // Closure model name
    this->setName(_equation_name + " Diffusion Flux");
}

//---------------------------------------------------------------------------//
template<class EvalType, class Traits>
void VariableDiffusionFlux<EvalType, Traits>::evaluateFields(
...
//---------------------------------------------------------------------------//
template<class EvalType, class Traits>
KOKKOS_INLINE_FUNCTION void VariableDiffusionFlux<EvalType, Traits>::operator()(
...
#endif // end VERTEXCFD_CLOSURE_VARIABLEDIFFUSIONFLUX_IMPL_HPP
