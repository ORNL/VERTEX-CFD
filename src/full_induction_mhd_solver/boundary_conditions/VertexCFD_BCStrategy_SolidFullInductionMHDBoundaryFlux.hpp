#ifndef VERTEXCFD_BOUNDARYCONDITION_SOLIDFULLINDUCTIONMHDBOUNDARYFLUX_HPP
#define VERTEXCFD_BOUNDARYCONDITION_SOLIDFULLINDUCTIONMHDBOUNDARYFLUX_HPP
...
class SolidFullInductionMHDBoundaryFlux
    : public BoundaryFluxBase<EvalType, NumSpaceDim>
{
  ...
  private:
    ...
    std::unordered_map<std::string, std::string> _equ_dof_sim_pair;
...
#endif // end VERTEXCFD_BOUNDARYCONDITION_SOLIDFULLINDUCTIONMHDBOUNDARYFLUX_HPP
