#ifndef VERTEXCFD_CLOSURE_SOLIDFULLINDUCTIONCONVECTIVEFLUX_HPP
#define VERTEXCFD_CLOSURE_SOLIDFULLINDUCTIONCONVECTIVEFLUX_HPP
...
{
//---------------------------------------------------------------------------//
// Solid domain (zero velocity) full induction convective flux evaluation.
//---------------------------------------------------------------------------//
template<class EvalType, class Traits, int NumSpaceDim>
class SolidFullInductionConvectiveFlux
...
#endif // end VERTEXCFD_CLOSURE_SOLIDFULLINDUCTIONCONVECTIVEFLUX_HPP
